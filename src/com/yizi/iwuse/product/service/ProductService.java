...
public class ProductService implements ICoreService {
	...
	ThemeItem item0 = new ThemeItem("张一", R.drawable.image1, "分类类型", "图片",
		null);
	ThemeItem item1 = new ThemeItem("李二", R.drawable.image2, "分类类型", "视频",
		vdoPath);
	ThemeItem item2 = new ThemeItem("张三", R.drawable.image1, "分类类型", "视频",
		vdoPath);
	ThemeItem item3 = new ThemeItem("李四", R.drawable.image3, "分类类型", "图片",
		null);
	ThemeItem item4 = new ThemeItem("张五", R.drawable.image1, "分类类型", "图片",
		null);
	ThemeItem item5 = new ThemeItem("李六", R.drawable.image2, "分类类型", "图片",
		null);
	...
	ProductItem item0 = new ProductItem("张一", R.drawable.image1, "分类类型",
		"图片");
	ProductItem item1 = new ProductItem("李二", R.drawable.image2, "分类类型",
		"图片");
	ProductItem item2 = new ProductItem("张三", R.drawable.image3, "分类类型",
		"图片");
	ProductItem item3 = new ProductItem("李四", R.drawable.image4, "分类类型",
		"图片");
	ProductItem item4 = new ProductItem("张五", R.drawable.image5, "分类类型",
		"图片");
	ProductItem item5 = new ProductItem("李六", R.drawable.image6, "分类类型",
		"图片");
	ProductItem item7 = new ProductItem("李八", R.drawable.image1, "分类类型",
		"图片");
	ProductItem item8 = new ProductItem("张九", R.drawable.image2, "分类类型",
		"图片");
	ProductItem item9 = new ProductItem("李十", R.drawable.image3, "分类类型",
		"图片");
	ProductItem item10 = new ProductItem("张十一", R.drawable.image4, "分类类型",
		"图片");
	ProductItem item11 = new ProductItem("李十二", R.drawable.image5, "分类类型",
		"图片");
	ProductItem item12 = new ProductItem("张十三", R.drawable.image6, "分类类型",
		"图片");
