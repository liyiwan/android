...
public class LoginActivity extends BaseActivity {
	...
	// 微信授权
	weichatApi = WXAPIFactory.createWXAPI(this,
		UserConst.OAUTH_WEICHAT_APPID, true);
	...
	mAuthInfo = new AuthInfo(this, UserConst.OAUTH_WEIBO_APPID,
		UserConst.OAUTH_WEIBO_REDIRECT_URL, UserConst.OAUTH_WEIBO_SCOPE);
	// mController =
	// UMServiceFactory.getUMSocialService(UserConst.LOGIN_YOUMENG);
	// registLoginHandler();
    }
     ...
     * @param view
     */
    @OnClick({ R.id.btn_switch_login, R.id.btn_switch_regist, R.id.btn_login,
	    R.id.txt_forgetuserinfo, R.id.img_oauth_weichat, R.id.img_oauth_qq,
	    R.id.img_oauth_paybao, R.id.img_oauth_weibo,
	    R.id.img_userlogin_back, R.id.btn_regist_connfirm })
	...
	if (mTencent != null && mTencent.isSessionValid()) {
		...
		public void onComplete(final Object response) {
		    ...
		    AppContext.instance().userService.onLoginUpdateUserInfo(
			    login_type, response);
		}
    ...
    /**
     * 授权第三方登录。如果授权成功，则获取用户信息 微信、QQ、微博
     * 
     * @param platform
     */
    ...
    // AppContext.instance().globalContext.getString(R.string.oauth_promt_failed),Toast.LENGTH_SHORT).show();
    // }
    //
    // @Override
    ...
    // Toast.makeText(LoginActivity.this,
    // AppContext.instance().globalContext.getString(R.string.oauth_promt_cancel),
	...
	case UserConst.ENVENTTYPE_LOGIN:
	    Toast.makeText(mContext, mContext.getString(R.string.login),
