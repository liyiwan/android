 ...
 */
@SuppressLint("NewApi")
public class VideoWidget extends View implements OnCompletionListener,
     ...
     * @param videoPath
     */
    public VideoWidget(final Activity mContext, ViewGroup parentView,
	...
	btn_vdowidget_enterwuse = (Button) view
		.findViewById(R.id.btn_vdowidget_enterwuse);
	...
	try {
	  ...
	  * catch (IOException e) { ILog.e(TAG, e); }
	  */
	...
	// 设置surfaceView的布局参数
	surfaceView.setLayoutParams(new RelativeLayout.LayoutParams(vWidth,
		vHeight));
	// 然后开始播放视频
	player.start();
    }
