 ...
 */
@SuppressLint("NewApi")
public class ThemeVideoWidget extends View implements OnCompletionListener,
    ...
    public ThemeVideoWidget(final Activity mContext, SurfaceView view,
	    final String videoPath, int maxHeight) {
	super(mContext);
	try {
