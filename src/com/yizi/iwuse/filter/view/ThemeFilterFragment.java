...
public class ThemeFilterFragment extends Fragment implements OnTouchListener {
		...
		new GestureDetector.SimpleOnGestureListener() {
			...
			if ((e1.getRawY() - e2.getRawY()) > 200) {
			    FragmentTransaction transaction = mFragmentManager
				    .beginTransaction();
			    transaction.setCustomAnimations(R.anim.slide_up_in,
				    R.anim.slide_up_out);
			    MainHomeFragment.isFilterOpen = false;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
	    ...
	    String filterItem = filterArray.get(position);
	    if (convertView == null) {
		viewHolder = new ViewHolder();
		convertView = LayoutInflater.from(getActivity()).inflate(
			R.layout.theme_filter_item, null);
		viewHolder.tv_select = (TextView) convertView
	    ...
	    viewHolder.tv_select.setText(filterItem);
	    return convertView;
	}
